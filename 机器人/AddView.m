...
-(void)setupButton
{
    ...
    AddViewButton *btn2 = [[AddViewButton alloc]initWithFrame:CGRectMake(160, 30, 60, 80)];
    ...
    AddViewButton *btn3 = [[AddViewButton alloc]initWithFrame:CGRectMake(280, 30, 60, 80)];
    ...
    [btn4 setTitle:@"名言" forState:UIControlStateNormal];
    [btn4 addTarget:self action:@selector(btn4click) forControlEvents:UIControlEventTouchDown];
    [self addSubview:btn4];
    self.btn4 = btn4;

    AddViewButton *btn5 = [[AddViewButton alloc]initWithFrame:CGRectMake(160, 120, 60, 80)];
    ...
    AddViewButton *btn6 = [[AddViewButton alloc]initWithFrame:CGRectMake(280, 120, 60, 80)];
